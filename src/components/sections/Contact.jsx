...
const Contact = () => {
  ...
  <div className="container mx-auto px-4 sm:px-6">
    ...
    {/* Conteneur en 2 colonnes avec hauteurs égales */}
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-stretch">
      ...
      {/* Colonne de droite : Formulaire de contact (2/3 largeur) */}
      <div className="lg:col-span-2 bg-gray-50 p-8 md:p-12 rounded-3xl flex flex-col">
