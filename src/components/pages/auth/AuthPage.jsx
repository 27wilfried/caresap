    ...
    if (isLogin) {
      ...
      try {
        ...
        toast.current.show({
          severity: "error",
          summary: "Erreur",
          detail: error?.data?.message || error?.response?.data?.message || "Erreur lors de l'authentification.",
          life: 3000,
        });
      ...
      try {
        ...
        toast.current.show({
          ...
          summary: "Erreur",
          detail:
            error?.data?.message || error?.response?.data?.message || "Erreur lors de la création du compte.",
          life: 3000,
        });
      }
    }
