...
const ProductsList = ({ products, collection, onBack, onEdit, onDelete, onAddNew }) => {
    ...
    <>
      <div className="flex items-center mb-6">
        ...
        <div className="flex items-center">
          {IconComponent && <IconComponent className="mr-2 text-indigo-500" size={32} />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.length === 0 ? (
          <p className="text-gray-500 col-span-3 text-center">Aucun produit pour cette collection. Ajoutez-en un !</p>
        ) : (
